 ...
 */
final class Version20240116192717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parrainage ADD talibe_id INT NOT NULL, ADD user_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_195BAFB542E0616F ON parrainage (talibe_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_195BAFB542E0616F ON parrainage');
        $this->addSql('DROP INDEX IDX_195BAFB5A76ED395 ON parrainage');
        $this->addSql('ALTER TABLE parrainage DROP talibe_id, DROP user_id');
    }
}
