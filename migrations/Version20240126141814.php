 ...
 */
final class Version20240126141814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dahra (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, nom_ouztas VARCHAR(255) NOT NULL, numero_telephone_ouztas VARCHAR(255) NOT NULL, nombre_talibe INT NOT NULL, INDEX IDX_487266D4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE talibe (id INT AUTO_INCREMENT NOT NULL, dahra_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, adresse VARCHAR(255) NOT NULL, situation VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, date_arrive_talibe DATE DEFAULT NULL, presence_talibe VARCHAR(255) NOT NULL, INDEX IDX_D9C6946F616D84A5 (dahra_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
